    ...
    <>
      <style
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .w-wide { grid-column: span 4; min-height: 100px; display:flex; align-items:center; justify-content:space-between; cursor: default; }
        ...
        <div className="toast">
          <div
            style={{
              fontWeight: 900,
              marginBottom: 4,
              color: toast.t === "error" ? "#fca5a5" : toast.t === "success" ? "#86efac" : "#e2e8f0",
            }}
          >
            {toast.t.toUpperCase()}
          </div>
        ...
        <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", padding: 18 }}>
          <div className="card" style={{ width: 420, textAlign: "center" }}>
            ...
            <div style={{ textAlign: "left", marginBottom: 12 }}>
              <div style={{ fontSize: "0.75rem", color: "var(--primary)", fontWeight: 900, marginBottom: 8 }}>
                IDENTIFIANT
              </div>
            ...
            <button className="btn btn-ghost" style={{ width: "100%", marginTop: 10 }} onClick={loadMeta}>
        ...
        <div className="app-container">
          <header className="topbar">
            ...
            <div style={{ display: "flex", gap: 10 }}>
              ...
              <button className={`btn ${tab === "invoice" ? "btn-primary" : "btn-ghost"}`} onClick={() => setTab("invoice")}>
                Caisse
              </button>
              <button className={`btn ${tab === "direction" ? "btn-primary" : "btn-ghost"}`} onClick={() => setTab("direction")}>
                Direction
              </button>
              <button className={`btn ${tab === "annuaire" ? "btn-primary" : "btn-ghost"}`} onClick={() => setTab("annuaire")}>
                Annuaire
              </button>
            </div>
          ...
          {tab === "dashboard" && (
            <section>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "end", marginBottom: 20 }}>
                ...
                <button className="btn btn-ghost" onClick={loadMeta}>
                  ☁️ Sync Sheet
                </button>
              </div>
              ...
              <div className="bento-grid">
                <div className="widget w-large" onClick={() => setTab("invoice")}>
                  <div>
                    ...
                    <div className="w-stat" style={{ marginTop: 10 }}>
                      CAISSE
                    </div>
              ...
              <div className="pos-layout">
                <div className="card" style={{ padding: 16, overflow: "hidden" }}>
                  <div style={{ display: "flex", gap: 10, marginBottom: 10 }}>
                    ...
                    <button className="btn btn-ghost" onClick={() => { setSearch(""); setOpenCat(null); }}>
                      Reset
                    </button>
                  </div>
                  ...
                  <div className="accordion">
                    {filteredCategories.map((cat) => (
                      <div className="cat" key={cat}>
                        <div className="cat-h" onClick={() => setOpenCat((prev) => (prev === cat ? null : cat))}>
                ...
                <div className="ticket">
                  <div className="ticket-head">
                    ...
                    <div style={{ marginTop: 10, color: "var(--text-muted)", fontSize: "0.85rem" }}>
                      Remise appliquée: <b style={{ color: "var(--text)" }}>{discountType}</b> •{" "}
                      <b style={{ color: "var(--primary)" }}>{appliedDiscountPct}%</b>
                    </div>
                  </div>
                        ...
                        <div className="cart-item" key={it.desc}>
                          <div>
                            ...
                            <div style={{ color: "var(--text-muted)", fontFamily: "var(--font-data)", fontSize: "0.85rem" }}>
                              {currencySymbol}
                              {it.pu.toFixed(2)} × {it.qty}
                            </div>
                          </div>
                          <div className="cart-actions">
                            <button className="btn btn-ghost qty-btn" onClick={() => modQty(it.desc, -1)}>
                              -
                            </button>
                            <button className="btn btn-ghost qty-btn" onClick={() => modQty(it.desc, +1)}>
                              +
                            </button>
                            <button className="btn btn-danger qty-btn" onClick={() => modQty(it.desc, -999)}>
                              ✕
                            </button>
                          </div>
                        </div>
                  ...
                  <div className="ticket-foot">
                    <div className="row">
                      ...
                      <strong style={{ fontFamily: "var(--font-data)" }}>
                        {currencySymbol}
                        {subtotal.toFixed(2)}
                      </strong>
                    </div>
              ...
              {!adminUnlocked ? (
                <div className="card" style={{ maxWidth: 520, margin: "60px auto", borderColor: "rgba(239,68,68,0.25)" }}>
                  ...
                  <div style={{ marginTop: 14, color: "var(--text-muted)", fontSize: "0.85rem" }}>
                    *Le PIN vient du Sheet (onglet <b>Config</b>, clé <b>ADMIN_PIN</b>)
                  </div>
                </div>
              ) : (
                <div>
